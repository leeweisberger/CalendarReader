...
public class ImageProcessingUtils {
	...
	private static final int THRESH_CONSTANT = 10;
	private static final int THRESH_BLOCKSIZE = 75;
	...
	public static void applyAdaptiveThreshold(Mat m){
		Imgproc.adaptiveThreshold(m, m, MAX_THRESH,Imgproc.ADAPTIVE_THRESH_MEAN_C , Imgproc.THRESH_BINARY, THRESH_BLOCKSIZE, THRESH_CONSTANT);
